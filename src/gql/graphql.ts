...
export type CartFragmentFragment = { id: string, orderItems: Array<{ id: string, quantity: number, total: number, product?: { id: string, name: string, price: number } | null }> };
...
export type CategoriesGetProductsQuery = { categories: Array<{ id: string, products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> }> };
...
export type CollectionsGetSingleOpneQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']['input']>;
}>;


export type CollectionsGetSingleOpneQuery = { collections: Array<{ id: string, name: string, slug: string, description?: string | null, products: Array<{ id: string, name: string, description: string, price: number, images: Array<{ url: string }> }> }> };
...
export type ProductsGetListBySearchQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };

export type ProductGetSingleOneQueryVariables = Exact<{
  id?: InputMaybe<Scalars['ID']['input']>;
}>;


export type ProductGetSingleOneQuery = { product?: { id: string, name: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null };
...
export const CategoriesGetProductsDocument = new TypedDocumentString(`
  ...
  price
}`) as unknown as TypedDocumentString<CategoriesGetProductsQuery, CategoriesGetProductsQueryVariables>;
...
export const CollectionsGetSingleOpneDocument = new TypedDocumentString(`
  ...
  collections(where: {slug: $slug}) {
    ...
    `) as unknown as TypedDocumentString<CollectionsGetSingleOpneQuery, CollectionsGetSingleOpneQueryVariables>;
...
export const ProductGetSingleOneDocument = new TypedDocumentString(`
